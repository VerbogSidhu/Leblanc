...
enum retro_environment_cmd
{
   ...
   RETRO_ENVIRONMENT_SET_CORE_OPTIONS_DISPLAY = 56,
   RETRO_ENVIRONMENT_GET_PREFERRED_HW_RENDER = 57,
   RETRO_ENVIRONMENT_GET_DISK_CONTROL_INTERFACE_VERSION = 58,
   RETRO_ENVIRONMENT_SET_DISK_CONTROL_EXT_INTERFACE = 59,
   RETRO_ENVIRONMENT_GET_MESSAGE_INTERFACE_VERSION = 60,
   RETRO_ENVIRONMENT_SET_MESSAGE_EXT = 61,
   RETRO_ENVIRONMENT_GET_INPUT_MAX_USERS = 62,
   RETRO_ENVIRONMENT_SET_AUDIO_BUFFER_STATUS_CALLBACK = 63,
   RETRO_ENVIRONMENT_SET_MINIMUM_AUDIO_LATENCY = 64,
   RETRO_ENVIRONMENT_SET_FASTFORWARDING_OVERRIDE = 65,
   RETRO_ENVIRONMENT_SET_CONTENT_INFO_OVERRIDE = 66,
   RETRO_ENVIRONMENT_GET_GAME_INFO_EXT = 67,
   RETRO_ENVIRONMENT_SET_CORE_OPTIONS_V2 = 68,
   RETRO_ENVIRONMENT_SET_CORE_OPTIONS_V2_INTL = 69,
   RETRO_ENVIRONMENT_SET_CORE_OPTIONS_UPDATE_DISPLAY_CALLBACK = 70,
   RETRO_ENVIRONMENT_SET_VARIABLE = 71,
   RETRO_ENVIRONMENT_GET_THROTTLE_STATE = 72,
   RETRO_ENVIRONMENT_GET_SAVESTATE_CONTEXT = 73,
   RETRO_ENVIRONMENT_GET_HW_RENDER_CONTEXT_NEGOTIATION_INTERFACE_SUPPORT = 74,
   RETRO_ENVIRONMENT_GET_JIT_CAPABLE = 75,
   RETRO_ENVIRONMENT_GET_MICROPHONE_INTERFACE = 76,
